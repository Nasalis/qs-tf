...
public class ByteOrderMarkTest  {
    ...
    public void testConstantCharsetNames() {
        assertNotNull(Charset.forName(ByteOrderMark.UTF_8.getCharsetName()), "Test charset for UTF_8");
        assertNotNull(Charset.forName(ByteOrderMark.UTF_16BE.getCharsetName()), "Test charset for UTF_16BE");
        assertNotNull(Charset.forName(ByteOrderMark.UTF_16LE.getCharsetName()), "Test charset for UTF_16LE");
        assertNotNull(Charset.forName(ByteOrderMark.UTF_32BE.getCharsetName()), "Test charset for UTF_32BE");
        assertNotNull(Charset.forName(ByteOrderMark.UTF_32LE.getCharsetName()), "Test charset for UTF_32LE");
    }
